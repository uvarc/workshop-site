...
library(knitr)
opts_chunk$set(results="show", message=FALSE, fig.show="hide", fig.keep="none")
options(digits=3)
...
This is not a beginner course. This workshop requires basic familiarity with R: data types including vectors and data frames, importing/exporting data, and plotting. You can refresh your R knowledge with the [Introduction to R](/lesson/r-intro/) or any number of free online resources including: 

- [DataCamp's Intro to R](https://www.datacamp.com/courses/introduction-to-r)
- [CodeAcademy's Learn R](https://www.codecademy.com/learn/learn-r)
...
Before coming, you should have downloaded the [gapminder data](/data/gapminder.csv). This dataset is an excerpt from the [Gapminder](http://www.gapminder.org/) data, that's [already been cleaned up to a degree](https://github.com/jennybc/gapminder). This particular dataset has 1704 observations on six variables:
