...
knitr::include_graphics("/images/diff_small.png")
```
...
```{r, out.width = "100%", eval=TRUE}
knitr::include_graphics("/images/plospaper.png")
```
...
<table class="table">
  <tbody>
    <tr>
      <td><img src="/images/git.svg" style="width:100px;height:100px;"><img></td>
      <td style = "padding-left:50px;"><h3>Git</h3></td>
      <td style = "padding-left:50px;">Version control software</td>
    </tr>
    <tr>
      <td><img src="/images/github-desktop.png" style="width:100px;height:100px;"></img></td>
    ...
    <tr>
      <td><img src="/images/github.png" style="width:100px;height:100px;"></img></td>
    ...
    <tr>
      <td><img src="/images/bitbucket.png" style="width:100px;height:100px;"></img></td>
    ...
    <tr>
      <td><img src="/images/gitlab.svg" style="width:100px;height:100px;"></img></td>
